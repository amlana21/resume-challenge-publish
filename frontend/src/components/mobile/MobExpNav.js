  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Tab label="Technical Architect (Sr. Consultant)" {...a11yProps(1)} />
        <Tab label="Sr. Technical Lead(Consultant)" {...a11yProps(2)} />
        <Tab label="Technical Lead(Consultant)" {...a11yProps(3)} />
        <Tab label="Technical Analyst" {...a11yProps(4)} />
        <Tab label="Programmer Trainee" {...a11yProps(5)} />
        {/* <Tab label="Item Seven" {...a11yProps(6)} /> */}
      </Tabs>
      <TabPanel value={value} index={0} style={{position:'relative',height:'200px'}}>
        <div style={{height:'575px',position:'relative',overflow:'scroll'}}>
