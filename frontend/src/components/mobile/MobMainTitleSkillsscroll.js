...
export default function TextMobileStepper() {
  ...
  return (
    <div className={classes.root}>
        ...
        {tutorialSteps.map((step, index) => (
          <div key={step.label}>
            {Math.abs(activeStep - index) <= 1 ? (
              <Paper square elevation={0} className={[classes.header,'mobmainscrolltopdiv'].join(' ')}>
              <Typography variant="h6" component="h2" className='mobmaintitlscroll' >{tutorialSteps[activeStep].label}</Typography>
            </Paper>
            ) : null}
          </div>
        ))}
      ...
      <MobileStepper
        steps={maxSteps}
        className='mobmainscrollbottomdiv'
        position="static"
        variant="text"
